...
const UUID           = process.env.UUID           || 'c3d3710e-5ec2-4dd7-93d1-578595849d07'; // UUID，运行哪吒请修改
const NEZHA_SERVER   = process.env.NEZHA_SERVER   || 'nezha.babiq.eu.org';         // 哪吒面板地址，v1形式：nz.serv00.net:8008
const NEZHA_PORT     = process.env.NEZHA_PORT     || '443';         // v1哪吒请留空，v0 agent端口
const NEZHA_KEY      = process.env.NEZHA_KEY      || '4XKcsNQ6tmUcrvyYA9';         // v1的NZ_CLIENT_SECRET或v0 agent密钥
const ARGO_DOMAIN    = process.env.ARGO_DOMAIN    || 'miget.future13800.eu.org';         // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH      = process.env.ARGO_AUTH      || 'eyJhIjoiNjc0MmMxNDI5ZDE4OTA3NjMzZjMyZjQ2MWM5MzUwOWMiLCJ0IjoiYzdkMzY5OTktNGNjOC00MTdlLTkxZWEtMmZkYjgwYzBhZWNkIiwicyI6Ik9EVTVOV1ptTm1VdE1qUXhZaTAwWWpabUxUZzJaalF0TVRNME1Ea3dZemsxT1dOaSJ9';         // argo固定隧道token或json,留空即使用临时隧道
